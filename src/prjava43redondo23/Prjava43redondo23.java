package prjava43redondo23; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*; // using AWT events and listener interfaces 
import java.sql.*;
import java.io.*; 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43redondo23 extends Frame 
   ...
   public Prjava43redondo23 () { 
      ...
      setTitle("nova finestra prjava43redondo23");// "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43redondo23();  // Let the construct do the job 
   } 
